...
SELECT 'orders:update_payment_method', 'Update Payment Method', '修改支付方式', 'orders', 'update', 'all', 'orders', 'orders', '/api/business/orders/*/payment-method', 'PUT', '修改订单的支付方式', 'ACTIVE', NOW(), NOW()
    WHERE NOT EXISTS (

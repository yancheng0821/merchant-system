...
public class BusinessLogAspect {
     ...
     * 拦截所有 Controller 方法
     */
    @Around("execution(* com.merchant.server.authservice.controller..*(..))")
    ...
    private Map<String, Object> extractKeyFields(Object obj) {
        ...
        try {
            ...
            // 提取常见的关键字段
            String[] keyFieldNames = {"id", "tenantId", "userId", "username", "email",
                "phone", "roleId", "roleName", "permissionId", "status"};

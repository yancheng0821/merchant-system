...
public class BusinessLogAspect {
     ...
     * 拦截所有 Controller 方法
     */
    @Around("execution(* com.merchant.server.notificationservice.controller..*(..))")
    ...
    private Map<String, Object> extractKeyFields(Object obj) {
        ...
        try {
            ...
            // 提取常见的关键字段
            String[] keyFieldNames = {"id", "tenantId", "userId", "notificationId", "templateId",
                "type", "channel", "recipient", "subject", "status"};
